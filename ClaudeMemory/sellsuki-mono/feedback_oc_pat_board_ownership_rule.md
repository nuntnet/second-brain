...
**Reconciliation executed 2026-07-04:** PAT-2477/PAT-2517/PAT-2522 → Rejected (PAT transition id `4`; content merged into OC-4287/OC-4321/OC-4322). OC-4285 (omni decision spike) → Done obsolete — decision was made 2026-07-03 on PAT side: BUILD NEW greenfield inbox = PAT-2506 (epic) + PAT-2513 (scaffold); OC-4225/OC-4320 updated to align. OC-4287 rewritten: no longer "stakeholder decision" — blocked-by PAT-2300 (OMS order v2 producer, `patona.oms.order.created/updated.v2`), consumer contract merged from PAT-2477 (customer_activity table, group `oc2plus-customer-activity`, member-match read-only, no-match=skip). Open: whether PAT-2506/2513 (inbox service = OC2Plus-scope per rule) should migrate to OC board — flagged, user hasn't decided.
