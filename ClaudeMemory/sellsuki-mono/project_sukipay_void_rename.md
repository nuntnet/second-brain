...
**EXECUTED แล้ว (2026-07):** Jira 12 cards แก้จริง (rename ครบ, payment VOIDED คงถูก) + Outline 11 docs แก้จริงครบ. เหลือ **code+migration = ยังไม่ทำ (เว้นให้ dev Chonchanok — breaking coordinated deploy)**. Format ตรวจแล้ว: rename integrity ถูกทุกใบ, ไม่มี card พังหนัก — แต่เจอ format artifact จากการ edit (ดู [[reference_jira_editissue_adf_breakage]]): PAT-2447 รูปฝังพัง, PAT-2036 Figma smartlink→literal, checkbox escape `\[ \]` ใน 2425/2288/2038/2036, escaped quotes PAT-2286. เกี่ยวกับ refund cluster ที่ทำใน session เดียวกัน.
